...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.advisor.jhbass.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.advisor.jhbass.security.DomainUserDetailsService", "createSpringSecurityUser");
